...
encoderResolution = 400;
FirstOrderKalman_InputGyro; % Run initial kalman
clc;
close all;

pedal.groundTruthTheta = smoothedTheta_values;
...
% Measurements
theta_measurements = sampleDecreaser(encoderResolution);
